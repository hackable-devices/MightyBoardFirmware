...
#define B_STEPPER_STEP          STEPPER_PORT(A,3)   //active rising edge
#define B_STEPPER_DIR           STEPPER_PORT(A,2)   //forward on high
#define B_STEPPER_ENABLE        STEPPER_PORT(A,5)   //active low

#define A_STEPPER_STEP          STEPPER_PORT(A,0)   //active rising edge
#define A_STEPPER_DIR           STEPPER_PORT(K,7)   //forward on high
#define A_STEPPER_ENABLE        STEPPER_PORT(A,1)   //active low
...
#define B_POT_PIN		Pin(PortA,4)
// B stepper potentiometer pin
#define A_POT_PIN   Pin(PortJ,7)
...
/// POWER Pins for heaters, fans and heated build platform
#define EXB_PWR	                Pin(PortE,5) // OC3C
#define EXA_PWR	                Pin(PortE,3) // OC3A
#define EXB_FAN                 Pin(PortH,4) // OC4B
#define EXA_FAN                 Pin(PortE,4) // OC3B
...
//
//Possible values are:/Users/tchap/Documents/home/www/MightyBoardFirmware/firmware/src/MightyBoard/shared/PID.cc
//
