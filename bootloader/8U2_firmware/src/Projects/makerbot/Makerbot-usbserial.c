...
/*
  ...
  MODIFIED FOR USE WITH MAKERBOT 3D PRINTERS
*/

/** \file
 *
 *  Main source file for the Makerbot-usbserial project. This file contains the main tasks of
 *  the project and is responsible for the initial application hardware configuration.
 */

#include "Makerbot-usbserial.h"
...
int main(void)
{
	...
	//Size Optimization (may speed up as well): Make the address local
